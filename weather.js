...
async function checkWeather(city)
{
    ...
    document.querySelector(".min_temp").innerHTML = Math.round((data1.main.temp_min)-273);
    document.querySelector(".max_temp").innerHTML = Math.round((data1.main.temp_max)-273);
    ...
    if(data1.weather[0].main==='Haze'){
      document.querySelector(".card_logo").src="./images/clear.png";
    }
